...
- (void)viewDidLoad
{
    ...
    NSString *moviesURLString = @"http://www.cs.sonoma.edu/~kooshesh/cs470/movies/dbInterface.py?rType=allMovies";
    
    self.dataSource = [[MoviesDataSource alloc] initWithMoviesAtURLString:moviesURLString];
...
{
    Movie *movie = [self.dataSource movieAtIndex:[indexPath row]];
